...
def recognize_attendence():
    ...
    fileName = "log" + os.sep + "UserDetails_" + date + "_" + Hour + ".csv"
    ...
    if os.path.exists(temp):
        ...
        new_file.drop_duplicates(subset=['Id'], keep='last', inplace=True)  # Changed 'first' to 'last'
    ...
    # Call function to calculate final attendance
